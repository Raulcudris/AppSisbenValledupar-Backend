 ...
 *
 * <p>Expone endpoints complementarios para registrar intentos
 * de llamada, asignar visitas a encuestadores y actualizar
 * resultados de visitas.</p>
 */
@RestController
...
public class CallCenterWorkflowController {
    ...
    public ApiResponse<List<CallCenterResultadoLlamadaResponse>>
    ...
    public ApiResponse<List<CallCenterGestionLlamadaResponse>>
    findLlamadasByCaso(
            @PathVariable
            Long id
    ) {
    ...
    public ApiResponse<CallCenterGestionLlamadaResponse>
    registrarLlamada(
            @PathVariable
            Long id,
    ...
    public ApiResponse<List<CallCenterVisitaResponse>>
    findVisitasByCaso(
            @PathVariable
            Long id
    ) {
     ...
     */
    @PreAuthorize(
            AppRolePreAuthorize.CALLCENTER_ASSIGN_ENCUESTADOR
    )
    ...
    @PatchMapping("/visitas/{visitaId}/programacion")
    public ApiResponse<CallCenterVisitaResponse>
    ...
    /**
     * Consulta las visitas asignadas.
     *
     * <p>Para FUNCIONARIO_ENCUESTADOR el servicio siempre
     * restringe la consulta al encuestador asociado al usuario
     * autenticado.</p>
     *
     * <p>ADMIN, COORDINADOR_CALLCENTER y FUNCIONARIO_CALLCENTER
     * pueden aplicar adicionalmente un filtro por encuestador.</p>
     */
    @PreAuthorize(AppRolePreAuthorize.CALLCENTER_READ)
    @GetMapping("/visitas/mis-asignaciones")
    public ApiResponse<PageResponse<CallCenterVisitaResponse>>
    misVisitas(
        ...
        CallCenterVisitaFilterRequest filter =
                new CallCenterVisitaFilterRequest(
                        q,
                        estadoVisita,
                        estadoCaso,
                        condicion,
     ...
     */
    @PreAuthorize(
            AppRolePreAuthorize.CALLCENTER_VISIT_UPDATE
    )
    @PatchMapping("/visitas/{visitaId}/resultado")
    public ApiResponse<CallCenterVisitaResponse>
    actualizarResultadoVisita(
            @PathVariable
            Long visitaId,
