 ...
 */
public interface CallCenterGestionLlamadaRepository extends JpaRepository<CallCenterGestionLlamada, Long> {
     ...
     */
    List<CallCenterGestionLlamada> findByCallCenterRegistroIdAndActivoTrueOrderByIntentoNumeroAscIdAsc(
     ...
     */
    long countByCallCenterRegistroId(Long callCenterRegistroId);
}
